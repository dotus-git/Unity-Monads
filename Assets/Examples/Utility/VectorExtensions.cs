...
public static class VectorExtensions
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Vector2Int ToV2IRound(this Vector2 vector2) =>
        new(Mathf.RoundToInt(vector2.x), Mathf.RoundToInt(vector2.y));

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Vector3Int ToV3I(this Vector2 vector2, int z = 0) =>
        new(Mathf.FloorToInt(vector2.x), Mathf.FloorToInt(vector2.y), z);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Vector3Int ToV3IRound(this Vector2 vector2, int z = 0) =>
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Vector2Int ToV2IRound(this Vector3 vector3) =>
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Vector3Int ToV3IRound(this Vector3 vector3) =>
